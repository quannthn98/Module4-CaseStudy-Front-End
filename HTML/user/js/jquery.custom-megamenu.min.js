...
!0).slideToggle(),a(this).find("span").html("View Less"))})},n=function(){b.on("click",function(){h.not(a(this).next()).stop(!0,!0).slideUp();b.not(a(this)).removeClass("adminJs-icon-changed");a(this).toggleClass("adminJs-icon-changed");a(this).next().stop(!0,!0).slideToggle()})},l=function(){991<c()&&991>=k&&(h.css("display",""),b.removeClass("adminJs-icon-changed"));c();k=c()};a.extend(f.prototype,{init:function(){n();m();l();a(d).resize(function(){l()})}});a.fn.MegaMenuDropDowns=function(b){return this.each(function(){a.data(this,
