...
e+"no-adminJs(\\s|$)"),"$1"+e+"adminJs$2"));a._config.enableClasses&&(b+=" "+e+d.join(" "+e),n?l.className.baseVal=b:l.className=b)})(m);delete k.addTest;delete k.addAsyncTest;for(g=0;g<a._q.length;g++)a._q[g]();p.Modernizr=a})(window,document);